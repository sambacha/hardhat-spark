...
Firstly let's try to explain what ignition is and what this tutorial is going to tackle.
...
You can see ignition documentation for more detailed explanation:
(https://github.com/Tenderly/ignition/blob/main/docs/concepts/module_builder/events.md)`;
