describe('mortar diff - unit', () => {
  ...
  it('should be able to show difference in modules - multiple modified binding');

  it('should do nothing if their is no difference in module');
  it ('should fail if their is less bindings in modules compared to deployed one');
});
